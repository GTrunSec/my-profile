...
(use-package! my-linux
  ...
  (setq inferior-julia-program-name "/nix/store/jq03h6f4zc1m4ixm3r5npc44cxhn5cvp-system-path/bin/julia ")
  )
#+end_src
...
(setq inferior-julia-program-name "~/anaconda3/bin/julia")
)
#+end_src
** macos-setting
