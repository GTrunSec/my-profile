...
(use-package! org-wild-notifier
  :defer t
  :config
  (add-hook! 'doomafter-init-hook 'org-wild-notifier-mode)
...
(use-package org-starter
  ...
  (org-starter-def "~/Documents/org-notes"
                   ...
                   ("myself.org"                   :agenda t :key "m" :refile (:maxlevel .5 ) )
                   ("Habit.org"                    :agenda t :key "h" :refile (:maxlevel .5 ))
...
;; (use-package! deft
;;   :config
;;   (setq deft-directory '("~/Documents/org-notes" "~/Documents/org-notes/post/myself"))
