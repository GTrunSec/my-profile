...
(define-key xah-fly-key-map (kbd "C-.") 'xah-fly-save-buffer-if-file)
...
;; scrolling
(define-key xah-fly-key-map (kbd "C-v") 'fast-scroll-scroll-up-command)
(define-key xah-fly-key-map (kbd "M-v") 'fast-scroll-scroll-down-command)
#+end_src
...
#+begin_src emacs-lisp :tangle "xah-fly.el"
   (defun gtrun-xah-dot-fly-key ()
        ...
        (cond
         ...
         ((eq major-mode 'elfeed-show-mode) (call-interactively 'scroll-up))
         ((eq major-mode 'elfeed-search-mode) (call-interactively 'scroll-up))
         (t nil)))
      ...
      (defun gtrun-xah-comma-fly-key ()
        ...
        (cond
         ...
         ((eq major-mode 'elfeed-show-mode) (call-interactively 'scroll-down))
         ((eq major-mode 'elfeed-search-mode) (call-interactively 'scroll-down))
         (t nil)))
