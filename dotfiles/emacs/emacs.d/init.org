...
#+begin_src emacs-lisp :tangle yes
  ...
  (add-hook 'ess-r-mode-hook 'gtrun/add-company-backend-global)
...
#+begin_src emacs-lisp :tangle yes
    (defun gtrun/add-company-backend-python ()
      (pop company-backends)
      (setq-local company-backends
                  (append '((company-tabnine company-files company-yasnippet))
                          company-backends)))

  (add-hook 'python-mode-hook 'gtrun/add-company-backend-python)
