...
#+hugo_publishdate: <2019-07-24 Wed 17:01>
...
(use-package beacon
  ...
  (beacon-mode +1))
    #+end_src
** ❤ Love [[https://github.com/jrblevin/deft][jrblevin/deft: Deft for Emacs]]
CLOSED: [2019-07-27 Sat 05:16]
#+begin_src emacs-lisp :tangle yes
...
(straight-use-package '(company-englisp-helper
   ...
   #+end_src
*** tabine
- [[https://github.com/TommyX12/company-tabnine][TommyX12/company-tabnine: A company-mode backend for TabNine, the all-language autocompleter: https://tabnine.com/]]
- [[https://tabnine.com/buy][Buy a license | TabNine]]
#+begin_src emacs-lisp :tangle yes
(use-package company-tabnine
:straight t)
#+end_src
*** ☟ NEXT [[https://github.com/SavchenkoValeriy/emacs-powerthesaurus][SavchenkoValeriy/emacs-powerthesaurus: Powerthesaurus integration for Emacs]]
...
*** 📄 REVIEW [#A] [[https://github.com/akirak/emacs.d/blob/master/main.org#org-ql][emacs.d/main.org at master · akrak/emacs.d]]
*** 📚 RELEASE [[https://github.com/akirak/emacs-config-library/blob/master/org-starter/.org-config.el][emacs-config-library/.org-config.el at master · akirak/emacs-config-library]]
    #+begin_src emacs-lisp :tangle yes
