...
*include coi sd dsds uds ncbiebfdb  dfo oejmkj dfgh lkh erhwslqpdnvngb  *** ✍ NOTE leader-key-map
#+begin_src emacs-lisp :tangle "./setup/xah-fly-key-normal.el"
  (require 'xah-fly-keys)
...
** [[https://github.com/zaiste/zaiste-emacs-theme][zaiste/zaiste-emacs-theme: This is the theme I use for the Doomcasts (short screencasts about Emacs Doom) - work-in-progress]]
...
#+end_src
** bookmark-heading
- [[https://github.com/Soft/emacs.d/blob/master/init/init-bookmarks.el#L58:L155][emacs.d/init-bookmarks.el at master · Soft/emacs.d]]
#+begin_src emacs-lisp :tangle yes
  (use-package bm
    :straight t
    :demand t
...
** ⚑ WAITING [[https://github.com/zonuexe/emacs-copyit][zonuexe/emacs-copyit: Copy it, yank anything!]]
* Project management
** projectile
...
*** [[https://github.com/emacs-helm/helm-sly][emacs-helm/helm-sly: Helm for SLY]]
** R
...
- [[https://github.com/enricoschumann/orgutils][enricoschumann/orgutils: R utilities for working with Org files]]
#+begin_src emacs-lisp :tangle yes
...
poly
- [[https://polymode.github.io/usage/][Basic Usage - Polymode]]
#+begin_src emacs-lisp :tangle yes
...
#+end_src
** ✘ CANCELED [[https://github.com/karlotness/tree-sitter.el][karlotness/tree-sitter.el: An Emacs dynamic module exposing tree-sitter.]]
CLOSED: [2019-07-25 Thu 19:55]
- State "✘ CANCELED" from "⚔ STARTED"  [2019-10-11 Fri 13:51] \\
  remove
...
* Org-mode
** Global
- git checkout 07e48a7af64e046cd6336b7d7440476f69524b1d
#+begin_src emacs-lisp :tangle yes
...
#+end_src
*** [[https://github.com/atheriel/org-clock-csv][atheriel/org-clock-csv: Export Emacs org-mode clock entries to CSV format.]]
#+begin_src emacs-lisp :tangle yes
(straight-use-package 'org-clock-csv)
(require 'org-clock-csv)
#+end_src
** org-element
*** [[https://github.com/floscr/emacs.d/blob/119bfd15319ba581793a66f8ee0417637f62298d/modules/languages/org/%2Bmy-agenda.el][emacs.d/+my-agenda.el at 119bfd15319ba581793a66f8ee0417637f62298d · floscr/emacs.d]]
** [[https://github.com/gizmomogwai/org-kanban][gizmomogwai/org-kanban: Kanban table for org-mode]]
** [[https://github.com/fuxialexander/org-pdftools][fuxialexander/org-pdftools]]                                     :PDF:READ:

** [[https://github.com/alphapapa/org-sidebar][alphapapa/org-sidebar: A helpful sidebar for Org mode]]
** [[https://github.com/twlz0ne/play-code.el][twlz0ne/play-code.el: Play code with online playgrounds]]
** 📄 REVIEW [[https://zzamboni.org/post/beautifying-org-mode-in-emacs/][zzamboni.org | Beautifying Org Mode in Emacs]]
** ✰ Important [[http://doc.rix.si/cce/cce-org.html][Complete Computing Environment: Org-Mode]]
** [[https://kitchingroup.cheme.cmu.edu/blog/category/org-mode/][The Kitchin Research Group: org-mode]]
...
#+begin_src emacs-lisp :tangle yes
  (setq org-publish-project-alist
        '(("nsm"
          ...
          ("nsm"
           :base-directory "~/Dropbox/Drop-project/my-code"
           :publishing-function org-html-publish-to-html
           :publishing-directory "~/Dropbox/application/Bitcron/gtrun.bitcron.com/custom"
           :exclude ".org"
           )
...
(require 'aweshell)
   #+end_src
** [[https://github.com/killdash9/better-shell/blob/master/better-shell.el][better-shell/better-shell.el at master · killdash9/better-shell]]
* Version control
** Magit
   #+begin_src emacs-lisp :tangle yes
     (use-package magit
     ...
     2. The status screen isn't buried when viewing diffs or logs from the status
       ...
       (defun magit-remove-git-lock-file ()
         ...
         (shell-command "~/.config/nixpkgs/dotfiles/emacs/emacs.d/bin/clean-git-lock.sh"))
       )
   #+end_src
 git-lock remove
** Magit-todos
...
** [[https://github.com/DarwinAwardWinner/dotemacs/blob/master/config.org][dotemacs/config.org at master · DarwinAwardWinner/dotemacs]]
** [[https://github.com/mpereira/.emacs.d/blob/master/configuration.org][.emacs.d/configuration.org at master · mpereira/.emacs.d]]
