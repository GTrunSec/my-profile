...
** org-mode set key
#+begin_src emacs-lisp :tangle "xah-fly-keys.el"
(global-set-key (kbd "M-s d") 'sl-quick-insert-drawer-link)
(global-set-key (kbd "M-s l") 'sl-quick-insert-inline-link)
(global-set-key (kbd "M-s i") 'org-roam-insert)
#+end_src

#+begin_src emacs-lisp :tangle "xah-fly-keys.el"
(when IS-MAC
  (global-set-key (kbd "C-x c-d") 'sl-quick-insert-drawer-link)
  (global-set-key (kbd "C-x c-l") 'sl-quick-insert-inline-link)
