...
#+RESULTS:
| fd-dired | counsel-recentf | counsel-find-file | project-find-file | counsel-rg | counsel-M-x | ace-window | org-roam-insert | org-z-insert-link | org-z-knowledge-search | org-roam-find-file | org-brain-visualize | org-brain-visualize-dwim | insert-current-date-time-inactive | insert-current-date-time-active | insert-current-date-time | bookmark-set | bookmark-bmenu-list | bm-toggle | +ivy/switch-buffer | +ivy/switch-workspace-buffer | helm-register | point-to-register | counsel-bookmark |
