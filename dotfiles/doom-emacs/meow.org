...
#+RESULTS:
| dired | counsel-recentf | counsel-find-file | +ivy/projectile-find-file | counsel-ag | ace-window | org-roam-insert | org-z-insert-link | org-z-knowledge-search | org-brain-visualize | org-brain-visualize-dwim | insert-current-date-time-inactive | insert-current-date-time-active | insert-current-date-time | bookmark-set | bookmark-bmenu-list | bm-toggle | counsel-bookmark |
