#+TITLE: GTrunSec's Doom Emacs config
...
(define-derived-mode only-file-to-org-mode org-mode "Org + only mode"
  ...
  (org-tanglesync-mode 1))
(add-to-list 'auto-mode-alist '("\\-README.org" . only-file-to-org-mode))
#+end_src
** org-setting
...
- [[*\[\[http://doc.norang.ca/org-mode.html\]\[Org Mode - Organize Your Life In Plain Text!\]\]][Org Mode - Organize Your Life In Plain Text!]]
...
(use-package! org-tanglesync
  ...
  :custom
  (org-tanglesync-watch-files '("~/.config/nixpkgs/dotfiles/dotfile-config.org"
                                "~/.config/nixpkgs/home-manager-README.org"
                                ))
  :config
...
(use-package! lsp-julia
  :init
  ;; (setq lsp-julia--self-path "~/.julia/packages")
