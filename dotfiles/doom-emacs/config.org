...
(use-package! calibredb
  ...
  (setq calibredb-library-alist '(("~/Dropbox/my-book")
                                  ))
  (setq calibredb-root-dir "~/Dropbox/my-book")
  (setq calibredb-db-dir (expand-file-name "calibredb-metadata.db" calibredb-root-dir))
  )
#+end_src
