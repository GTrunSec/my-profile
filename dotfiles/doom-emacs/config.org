...
(use-package! org-starter
  ...
  (org-starter-def "~/Documents/org-notes/braindump"
    :files
    ("private-org/" :agenda t)
    ("private-org/GTD/gtd.org"                      :key "g" :refile (:maxlevel . 5))
    ("private-org/GTD/notes.org"                    :key "n" :refile (:maxlevel . 5 ))
    ("private-org/GTD/myself.org"                    :key "m" :refile (:maxlevel . 5 ))
    ("private-org/GTD/Habit.org"                     :key "h" :refile (:maxlevel . 5 ))
    ("life/" :agenda t)
