...
* init.el
:PROPERTIES:
:ID:       0817e14a-4420-494f-a380-48986c6d6f5d
:END:
...
(after! nix-mode
  (setq +lsp-company-backends '(company-nixos-options
                                company-tabnine
                                :with
                                company-files
                                ))
...
** load basic config
#+begin_src emacs-lisp :tangle "./modules/private/my-org/config.el" :nowatch
(load! "setting")
(use-package! ox-hugo)
...
** org-starter
#+begin_src emacs-lisp :tangle  "./modules/private/my-org/packages.el" :nowatch
(package! org-starter)
#+end_src
...
(use-package! org-starter
 ...
 _s_: my-life
  "
      ...
      ("s" org-starter-find-file:life-things)
...
:PROPERTIES:
:ID:       e513ede6-3d58-4ef5-9152-dc809675e063
:END:
:BACKLINKS:
[2020-09-20 Sun 17:20] <- [[*Org-edna][Org-edna]]
:END:
...
- [[https://www.nongnu.org/org-edna-el/#org2421cd7][Org Edna]]

- [[id:e513ede6-3d58-4ef5-9152-dc809675e063][[[http://doc.norang.ca/org-mode.html][Org Mode - Organize Your Life In Plain Text!]​]​]]
...
(use-package! org-ref
  :config
  (setq org-ref-default-bibliography '("~/Documents/org-notes/bibliography/myBibliography.bib"))
  (setq bibtex-completion-bibliography "~/Documents/org-notes/bibliography/myBibliography.bib")
  )
#+end_src
...
;;; packages.el -*- lexical-binding: t; -*-
;;(package! lsp-julia :b342e5f74f9b815d2a7db9fffee7b9c46850d293 :recipe (:host github :repo "non-Jedi/lsp-julia"))
...
*** [[https://github.com/cdominik/cdlatex][cdominik/cdlatex: Fast input methods to enter LaTeX environments and math with GNU Emacs]]

*** TODO [[https://github.com/io12/org-fragtog][io12/org-fragtog: Automatically toggle org-mode latex fragment previews as the cursor enters and exits them]]
...
*** lsp-julia
- b342e5f74f9b815d2a7db9fffee7b9c46850d293
  #+begin_src emacs-lisp :tangle "./modules/private/my-code/packages.el"
(package! lsp-julia :pin "b342e5f74f9b815d2a7db9fffee7b9c46850d293" :recipe (:host github :repo "non-Jedi/lsp-julia"))
#+end_src
