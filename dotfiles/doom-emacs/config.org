...
#+TAGS: GTD(G) writing(w) export(e) manage(m) graphical(g)
#+BEGIN_QUOTE
HTML them READ org
...
;;load super-links from local path
;;(package! org-super-links :recipe (:host github :repo "toshism/org-super-links" :branch "develop"))
...
(use-package! org-super-links
  :load-path "~/.myscript/org-super-links"
  )

#+end_src

** org-clones
1. [[https://github.com/legalnonsense/org-clones][legalnonsense/org-clones: Prototype for method of cloning orgmore headers]]
