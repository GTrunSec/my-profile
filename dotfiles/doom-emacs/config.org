...
(use-package! org-starter
  ...
  (org-starter-def "~/Documents/org-notes/braindump"
    ...
    ("life/" :agenda t)
    ("GuangTao-owner/" :agenda t)
    ("GuangTao-owner/learn-music.org"          :agenda t :key "M" :refile (:maxlevel . 5 ))
    ("GuangTao-owner/GuangTao-library.org"       :key "b" :refile (:maxlevel . 5 ))
    ("life/" :agenda t)
    ("life/life-goods.org"     :key "s" :refile (:maxlevel . 5 ))
    ("gaming/" :agenda t)
    ("journals/" :agenda t)
    ("hardware/" :agenda t)
    ("system/" :agenda t)
