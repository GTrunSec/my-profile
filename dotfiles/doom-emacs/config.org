...
(use-package! org-starter
  ...
  (org-starter-def "~/Documents/org-notes"
    ...
    ("feed.org"         :agenda t :key "f" :refile (:maxlevel . 5 ))
    )
...
#+begin_src emacs-lisp :tangle  "./modules/private/my-org/packages.el"
(package! org-brain :recipe (:no-byte-compile t))
#+end_src
...
#+begin_src emacs-lisp :tangle "packages.el"
(unpin! polymode)
(package! poly-markdown :recipe (:no-byte-compile t))
#+end_src
...
*** FelipeLema/julia-formatter.el
  #+begin_src emacs-lisp :tangle "./modules/private/my-code/packages.el"
(package! julia-formatter :recipe (:type git :repo "https://codeberg.org/FelipeLema/julia-formatter.el.git"))
#+end_src
...
#+begin_src emacs-lisp :tangle "./modules/private/my-code/packages.el"
(package! nixpkgs-fmt :recipe (:host github :repo "purcell/emacs-nixpkgs-fmt"))
#+end_src
...
(use-package! nixpkgs-fmt
  ...
  :config
  (define-key nix-mode-map (kbd "C-c C-l") 'nixpkgs-fmt)
  )
#+end_src
...
(add-hook 'rustic-mode-hook (lambda () (setq-local +lsp-company-backends '(company-capf
                                                                           :separate
                                                                           company-tabnine))
                              (setq-local racer-rust-src-path "~/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/lib/rustlib/src/rust/src")
                              (setq-local rustic-racer-rust-src-path "~/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/lib/rustlib/src/rust/src")
                              )
          )
#+end_src
