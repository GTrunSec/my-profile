...
* pre setting && load
:PROPERTIES:
:ID:       b6737bcb-0b6f-4b05-a17b-a3ae206dc7e0
:END:
...
Version 2017-01-21"
  ...
  (xah-fly--define-keys
   ...
   '(
    ...
    (define-key xah-fly-key-map (kbd "p") 'gtrun-xah-fly-key-p)
    (define-key xah-fly-key-map (kbd "s-p") 'gtrun-xah-fly-key-P)
